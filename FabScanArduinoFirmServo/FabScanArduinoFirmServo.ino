...
//  J. Jimenez 28.07.2017 added G5 for managing miServo 

#include <Servo.h> //Para iniciar servo
...
{ 
  ...
  //version(); 
  //ready();
  miServo.attach(RIGHT_SERVO_PIN);
  miServo.write(87); // Default - Valor inicial comprobado
} 
